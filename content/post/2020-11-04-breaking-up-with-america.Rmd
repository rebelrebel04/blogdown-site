---
title: Breaking up with America
author:
date: '2020-11-04'
slug: breaking-up-with-america
categories: []
tags:
  - politics
---

![](/post/2020-11-04-breaking-up-with-america_files/chuttersnap-Odc4dcsjUBw-unsplash.jpg)
...
///it's not just a "flaw" marring an otherwise sound system -- rather, INABIAF: the paradigm of privelige was intentionally baked into the idea of America from the start


# Picking up the Pieces

* So what can I do? Lean into anti-racism? Become a social justice warrior working to dismantle the patriarchy from the inside?

///systemic privelige is by its nature invisible, particularly when you are raised within its coccoon from birth -- like a favority pair of shoes, you never notice them until you no longer have them. And then -- not through malintent, but just lack of awareness -- we confuse privelige for merit. 



///I only see two ways forward:
* outlast the generational damage Trump has done, waiting for his supporters to die out. this is the demographics for Democrats argument
* swing the Democrat party left, adopting a populist/social-democratic agenda, to pull those most in need of social support -- the very demographics [most susceptible to Trump's race-baiting, xenophobic demagogury](///link to my last post) -- back into the party that can actually help them. This is the "vote your self-interest, not your fears" argument


[^1]: The psychological dynamics of empathy are interesting in this context: Realizing that other groups are oppressed implies the realization that there must be an oppressor. And oppression is just the receiving end of privelige. It occurs to me that this might be the most effective angle from which a white man can be made to *see* his otherwise invisible systemic privelige. Rather than asking a white man if he's priveliged (which is virtually guaranteed to prompt a rebuke), it is better to ask: *Have you ever felt discriminated against? Have you ever felt oppressed?* The fact that we (white men) inevitably struggle to recall any such experiences proves the point: We have only escaped discrimination and oppression precisely because we are the priveliged class.
